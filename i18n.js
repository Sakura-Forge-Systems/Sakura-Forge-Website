(() => {
  const translations = {
    ja: {
      ...
      contact_tag: "お問い合わせ", contact_title_top: "その構想、", contact_title_em: "まずは聞かせてください。", contact_desc: "相談内容・希望時期・参考URLなど、分かる範囲でお送りください。依頼するか決まっていない段階でも構いません。", contact_note: "通常、内容を確認してから数日以内に返信します。",
      company_info_aria: "会社情報", company_name_label: "会社名", company_address_label: "本店所在地", company_business_label: "事業内容", company_business: "Webサイト制作、既存サイト改善、AIを活用した業務改善ツールの提案・開発、動画編集"
    },
    en: {
      ...
      contact_tag: "Contact", contact_title_top: "Have an idea?", contact_title_em: "Let’s talk about it.", contact_desc: "Send whatever you know—your goals, timing, or reference links. You are welcome to contact us before deciding to commission the work.", contact_note: "We usually reply within a few days after reviewing your message.",
      company_info_aria: "Company information", company_name_label: "Company", company_address_label: "Registered office", company_business_label: "Business", company_business: "Website development, website improvement, AI-powered workflow tool consulting and development, and video editing"
    },
    "zh-CN": {
      ...
      contact_tag: "联系我们", contact_title_top: "您的构想，", contact_title_em: "请先告诉我们。", contact_desc: "请发送您已确定的需求、期望时间或参考链接。即使尚未决定正式委托，也可以咨询。", contact_note: "通常会在确认内容后的几天内回复。",
      company_info_aria: "公司信息", company_name_label: "公司名称", company_address_label: "注册地址", company_business_label: "业务内容", company_business: "网站制作、现有网站优化、AI业务改善工具的提案与开发、视频剪辑"
    },
    "zh-TW": {
      ...
      contact_tag: "聯絡我們", contact_title_top: "您的構想，", contact_title_em: "先和我們聊聊。", contact_desc: "請提供已知的需求、期望時程或參考連結。即使尚未決定正式委託，也可以先諮詢。", contact_note: "通常會在確認內容後的幾天內回覆。",
      company_info_aria: "公司資訊", company_name_label: "公司名稱", company_address_label: "登記地址", company_business_label: "業務內容", company_business: "網站製作、現有網站改善、AI業務改善工具的提案與開發、影片剪輯"
    },
    ko: {
      ...
      contact_tag: "문의", contact_title_top: "그 아이디어를,", contact_title_em: "먼저 들려주세요.", contact_desc: "상담 내용, 희망 일정, 참고 링크 등 아는 범위에서 보내주세요. 의뢰 여부가 정해지지 않은 단계도 괜찮습니다.", contact_note: "내용 확인 후 보통 며칠 안에 답변드립니다.",
      company_info_aria: "회사 정보", company_name_label: "회사명", company_address_label: "본점 소재지", company_business_label: "사업 내용", company_business: "웹사이트 제작, 기존 사이트 개선, AI 업무 개선 도구 제안 및 개발, 영상 편집"
    },
    es: {
      ...
      contact_tag: "Contacto", contact_title_top: "¿Tienes una idea?", contact_title_em: "Cuéntanosla.", contact_desc: "Envíanos lo que sepas: objetivos, plazos o enlaces de referencia. Puedes consultarnos antes de decidir si encargas el proyecto.", contact_note: "Normalmente respondemos en unos días tras revisar tu mensaje.",
      company_info_aria: "Información de la empresa", company_name_label: "Empresa", company_address_label: "Domicilio social", company_business_label: "Actividad", company_business: "Desarrollo y mejora de sitios web, consultoría y desarrollo de herramientas de IA para procesos y edición de vídeo"
    },
    fr: {
      ...
      contact_tag: "Contact", contact_title_top: "Une idée ?", contact_title_em: "Parlons-en.", contact_desc: "Envoyez-nous les éléments disponibles : objectifs, calendrier ou liens de référence. Vous pouvez nous contacter avant toute décision.", contact_note: "Nous répondons généralement sous quelques jours après lecture de votre message.",
      company_info_aria: "Informations sur la société", company_name_label: "Société", company_address_label: "Siège social", company_business_label: "Activités", company_business: "Création et amélioration de sites web, conseil et développement d’outils IA pour les processus, et montage vidéo"
    },
    ru: {
      ...
      contact_tag: "Контакты", contact_title_top: "Есть идея?", contact_title_em: "Расскажите нам.", contact_desc: "Пришлите известные детали: цели, сроки или ссылки. Можно обратиться ещё до решения о заказе.", contact_note: "Обычно отвечаем в течение нескольких дней после ознакомления с сообщением.",
      company_info_aria: "Информация о компании", company_name_label: "Компания", company_address_label: "Юридический адрес", company_business_label: "Деятельность", company_business: "Разработка и улучшение сайтов, консультации и разработка ИИ-инструментов для рабочих процессов, видеомонтаж"
    },
    vi: {
      ...
      contact_tag: "Liên hệ", contact_title_top: "Bạn có ý tưởng?", contact_title_em: "Hãy chia sẻ với chúng tôi.", contact_desc: "Gửi những gì bạn đã biết: mục tiêu, thời gian hoặc đường dẫn tham khảo. Bạn có thể liên hệ trước khi quyết định đặt dự án.", contact_note: "Chúng tôi thường phản hồi trong vài ngày sau khi xem nội dung.",
      company_info_aria: "Thông tin công ty", company_name_label: "Công ty", company_address_label: "Trụ sở đăng ký", company_business_label: "Lĩnh vực", company_business: "Phát triển và cải thiện website, tư vấn và phát triển công cụ AI tối ưu công việc, biên tập video"
    },
    hi: {
      ...
      contact_tag: "संपर्क", contact_title_top: "कोई विचार है?", contact_title_em: "हमें बताएँ।", contact_desc: "अपने लक्ष्य, समय-सीमा या संदर्भ लिंक जैसी उपलब्ध जानकारी भेजें। काम देने का निर्णय लेने से पहले भी संपर्क कर सकते हैं।", contact_note: "संदेश देखने के बाद हम आमतौर पर कुछ दिनों में उत्तर देते हैं।",
      company_info_aria: "कंपनी की जानकारी", company_name_label: "कंपनी", company_address_label: "पंजीकृत कार्यालय", company_business_label: "व्यवसाय", company_business: "वेबसाइट निर्माण और सुधार, AI कार्य-सुधार उपकरणों की सलाह व विकास, और वीडियो संपादन"
    }
  };
